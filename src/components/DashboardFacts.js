...
const DashboardFacts = () => {
    ...
    const formatToCrores = (value) => (value / 10000000).toFixed(2) + " Cr.";
        ...
        useEffect(() => {
            ...
            const fetchPropertyData = async () => {
                try {
                    const response = await fetch("http://edharti.eu-north-1.elasticbeanstalk.com/api/property-count/summary");
    ...
    const factsData = [
        {
            ...
            factsTitle: Translate.totalProperties[lang],
            factsValue: (
                <CountUp
                    start={0}
        ...
        },
        {
            ...
            factsTitle: Translate.totalPlotArea[lang],
            factsValue: (
                <CountUp
                    start={0}
                    end={apiData.total_plot_area}
                    duration={5}
                    useEasing={true}
                    separator=","
                    suffix=" Sqm."  // <-- Added suffix here
                    enableScrollSpy={true}
                />
            )
        },        
        {
            ...
            factsTitle: Translate.totalLDOValue[lang],
            factsValue: (
                <CountUp
                    start={0}
                    end={apiData?.total_ldo_value || 0}
                    duration={5}
                    useEasing={true}
                    separator=","
                    enableScrollSpy={true}
                    formattingFn={(value) => formatToCrores(value)}
                />
            )
        },        
        {
            factsIcon: institutionalIcon,
            factsTitle: Translate.totalCRValue[lang],
            factsValue: (
                <CountUp
                    start={0}
                    end={apiData?.total_cr_value || 0}
                    duration={5}
                    useEasing={true}
                    separator=","
                    enableScrollSpy={true}
        ...
        },        
        {
            ...
            factsTitle: Translate.totalApplications[lang],
            factsValue: (
                <CountUp
                    start={0}
                    end={apiData.application_summary.total_applications}
                    duration={5}
                    useEasing={true}
                    separator=","
                    enableScrollSpy={true}
        ...
        },
        {
            ...
            factsTitle: Translate.approvedApplications[lang],
            factsValue: (
                <CountUp
                    start={0}
                    end={apiData.application_summary.app_approved_count}
                    duration={5}
                    useEasing={true}
                    separator=","
                    enableScrollSpy={true}
        ...
        },
        {
            ...
            factsTitle: Translate.rejectedApplications[lang],
            factsValue: (
                <CountUp
                    start={0}
                    end={apiData.application_summary.app_rejected_count}
                    duration={5}
                    useEasing={true}
                    separator=","
                    enableScrollSpy={true}
