...
const Page = () => {
    ...
    const eHearingLink = "http://edharti.eu-north-1.elasticbeanstalk.com/appointment-detail";
    // "https://ldo.gov.in/eDharti/SSL/NewUserRegistration/ApplicantRegistration/OnlineAppointment.aspx?id=a41e0eea6e85ed7490ac9d09fdfc94fb";

    const officeVisitLink = "http://edharti.eu-north-1.elasticbeanstalk.com/appointment-detail";
    // "https://ldo.gov.in/eDharti/SSL/NewUserRegistration/ApplicantRegistration/OfflineAppointment.aspx?id=76fc83e5c4f93adc2047d37380806c57";

    const setContactcontent = () => {
        let text1 =
            lang == "hindi"
                ? `
    भूमि तथा विकास कार्यालय द्वारा प्रशासित संपत्तियों के पट्टेदारों/मालिकों को सुविधा प्रदान करने के लिए बातचीत के विकल्पों को बढ़ाने का एक और उपाय किया गया है। यह निर्णय लिया गया है कि भौतिक सार्वजनिक बैठकें प्रत्येक बुधवार, गुरुवार और शुक्रवार को 1400-1500 बजे तक पूर्व निर्धारित समय पर आयोजित की जाएंगी`
                : `In a bid to facilitate the lessees/owners of the properties administered by the Land & Development Office another measure of augmenting the interaction options has been taken. It has been decided that the physical public meetings shall be held on prior appointments on every Wednesday, Thursday and Friday from 1400-1500 hrs.`;
        let text2 =
            lang == "hindi"
                ? `जनता के पास प्रत्येक बुधवार, गुरुवार और शुक्रवार को 1500-1530 बजे तक पूर्व नियत समय के साथ वर्चुअल प्लेटफॉर्म के माध्यम से बातचीत का अतिरिक्त विकल्प होगा`
                : `Public will have additional option of interaction through a virtual platform with a prior appointment on every Wednesday, Thursday and Friday from 1500-1530 hrs.`;

        setContent({
            heading: Translate.toBookAppointment[lang],
            text1: text1,
            text2: text2,
        });
    };
            ...
            <div className="introduction-container px-4 md:px-4 py-10 lg:px-8 xl:py-20 xl:px-10 2xl:px-24 2xl:py-10">
              ...
              <ul data-aos="fade-left" data-aos-duration="1000">
                ...
                <li className='mb-3 text-sm md:text-base lg:text-lg'><Image src={CheckIcon} alt='Check' className='inline w-4 md:w-5' /> Hence, it is expected that the request for such links be forwarded on aforementioned email-id at the earliest, latest by 2 PM on the day preceding the hearing of the matter.</li>
                            ...
                            <p>
                                <BtnLink
                                    href={officeVisitLink}
                                    target="_blank"
                                    text={
                                        Translate.officeVisitAppointment[lang]
                                    }
                                />
                            </p>
                            <p>{content.text2}</p>
                            <p>
                                <BtnLink
                                    href={eHearingLink}
                                    target="_blank"
                                    text={Translate.eHearingAppointment[lang]}
                                />
                            </p>
                        </div>
                    </div>
            ...
            <div className="tollfree-container relative px-4 py-10 md:px-4 lg:px-8 lg:py-28 xl:px-16 2xl:px-24 2xl:py-20">
                <div className="contact-tollfree z-10 relative bg-black/30 py-5 px-10 rounded-[10px] text-white md:flex items-center justify-center gap-10 backdrop-blur-md">
                    ...
                    >
                        ...
                        <h3
                            className="text-3xl md:text-4xl lg:text-5xl font-semibold ml-3"
                            data-aos="zoom-out-right"
                            data-aos-duration="1000"
                        >
                    ...
                    >
                        <Image
                            src={ArrowNarrowRightIcon}
                            alt="Arrow"
                            className="w-auto mr-3"
                        />
                        <Link
                            href={"tel:1800111705"}
                            className="tollfree-number text-4xl md:text-6xl lg:text-8xl"
                        >
                            1800111705
                        </Link>
                    </div>
                            ...
                            <div className="w-full py-4 md:w-2/3 px-4 md:py-0">
                                ...
                                >
                                    <div className="contact-Icons w-11 h-11 sm:w-16 sm:h-16 md:w-[85px] md:h-[85px] rounded-lg p-2 md:p-4 mr-3">
                                        <Image
                                            src={AddressLocationIco}
                                            alt="Address"
                                            className="w-full"
                                        />
                                    </div>
                                    {/* <h4 className="text-base lg:text-lg">Land and Development Office (MoHUA), <br /> Gate #4, A Wing, 6th floor, Nirman Bhawan</h4> */}
                ...
                <div className="flex items-center" data-aos="fade-up" data-aos-duration="2500">
                  ...
                  <h4>Twitter</h4>
                    ...
                    <div className="w-full lg:w-2/5 px-4 mt-10 lg:mt-0">
                        ...
                        >
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.651975694626!2d77.21483207500755!3d28.610215685094598!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce2b875b93a87%3A0xf3db6f0b6ba1a0f5!2sLand%20and%20Development%20Office!5e0!3m2!1sen!2sin!4v1709901097163!5m2!1sen!2sin"
                                width="100%"
                                height="320px"
                                className="border-0"
                                allowfullscreen=""
