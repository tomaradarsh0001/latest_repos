        ...
        <div className="services-offered-page">
            ...
            <div className="whatwedo px-4 md:px-6 pt-10 lg:px-8 xl:pt-20 xl:px-10 2xl:px-24 2xl:pt-10">
                <div className="w-full px-4">
                    <div
                        className="title-group2 pb-2 lg:pb-5 mb-5 flex justify-center"
                        data-aos="fade-up"
                        data-aos-duration="1000">
                        <h2 className="themeTitle bg-gray-200 h-[50px] w-[250px] animate-pulse rounded text-2xl lg:text-4xl font-bold text-center">
            ...
            <div className="px-4 md:px-4 py-10 lg:px-8 xl:py-20 xl:px-10 2xl:px-24 2xl:py-12 lg:mt-[50px]">
                ...
                {[...Array(20)].map((_, index) => (
                        <div
                            key={index}
                            className="services-card text-center w-full mb-14 md:mb-20"
                            data-aos="fade-up"
                            data-aos-duration="1000"
                        >
                            <Link href="" target="_blank">
                                <div className="w-24 h-24 md:w-28  md:h-28 lg:w-32 lg:h-32 m-auto">
                                    <div className="services-icon circle-sm circle2 text-center -mt-16 p-3 w-24 h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 m-auto flex items-center justify-center rounded-full md:-mt-16 lg:-mt-[5rem] bg-gray-200 md:p-4">
                                        
                                    </div>
                                </div>
                                <div className="services-title services-subtitle-group my-2 mt-3 flex justify-center">
                                    <h3 className="text-base 2xl:text-xl h-[40px] w-[250px] pb-2 font-medium opacity-60 bg-gray-200 animate-pulse rounded">
                                        
                                    </h3>
                                </div>
                            </Link>
                            <div className="services-description mt-2">
                                <div className="h-[120px] w-full bg-gray-200 animate-pulse rounded"></div>
                            </div>
                            <div className="services-link flex justify-center mt-3">
                                <div className="h-10 w-[150px] bg-gray-200 animate-pulse rounded"></div>
                            </div>
                        </div>
                    ))}
                </div>
    ...
    return servicesData.length == 0 ? (
        ...
        <div className="services-offered-page">
                ...
                <div className="services-row grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-11 2xl:grid-cols-4 2xl:gap-7 xl::grid-cols-4 xl:gap-6 lg:grid-cols-4 lg:gap-4 md:grid-cols-3 md:gap-5 md:mt-12">
                    {servicesData.map((item, index) => {
                        return (
                            ...
                            >
                                <Link
                                    href={"http://edharti.eu-north-1.elasticbeanstalk.com/"}
                                    target="_blank"
                                >
                                    <div className="w-24 h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 m-auto">
                                    ...
                                    <div className="services-title services-subtitle-group my-2 mt-3">
                                        <h3 className="text-base  2xl:text-xl pb-2 font-medium">
                                            {item.servicesTitle}
                                        </h3>
                                    </div>
                                </Link>
                                ...
                                <div className="services-link">
                                    <button
                                        ...
                                        className="text-sm sm:text-base inline-flex items-center justify-center"
                                    >
                                        {Translate.readMore[lang]}{" "}
                                        <EyeIcon className="ml-1 w-3 sm:w-4" />
                                    </button>
                                </div>
                            </div>
                        );
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal}>
                    ...
                    <div className="flex items-center justify-start">
                        <div className="w-24 h-24 md:w-28 md:h-28 lg:w-32 lg:h-32">
                            <div className="services-icon circle-sm circle2 text-center p-3 w-24 h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 m-auto flex items-center justify-center rounded-full bg-white md:p-4">
                                <Image
                                    src={HOST_NAME + activeModel.servicesIcon}
                                    alt="Substitution"
                                    className="w-12 h-12 md:w-auto md:h-auto object-cover m-auto"
                                    width={200}
                                    height={200}
                        ...
                        <div className="services-title services-subtitle-group my-2 ml-5">
                            <h3 className="text-base xl:text-2xl 2xl:text-4xl pb-2 font-medium">
                                {activeModel.servicesTitle}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div className="more-info-link p-2 mt-4 ml-5">
                    ...
                    {activeModel.link ? (
                        <Link
                            ...
                            href={
                                activeModel.link
                                    ? HOST_NAME + activeModel.link
                                    : "#"
                            }
                            target={activeModel.link ? "_balnk" : ""}
                        >
                            Read Docs{" "}
                        </Link>
                    ) : (
